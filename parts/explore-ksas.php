		...
		<div id="global-links" class="row small-up-2 medium-up-3 large-up-3">
			<div class="column column-block">
				...
				<ul class="vertical menu" role="menu">
					<li role="menuitem"><a href="<?php echo network_home_url(); ?>academics/departments-programs-and-centers/" onclick="ga('send', 'event', 'Offcanvas', 'Academics', 'Departments')";>Departments, Programs, and Centers</a></li>
					<li role="menuitem"><a href="<?php echo network_home_url(); ?>people/faculty/" onclick="ga('send', 'event', 'Offcanvas', 'Academics', 'Faculty')">Faculty Directory</a></li>
					<li role="menuitem"><a href="<?php echo network_home_url(); ?>academics/fields/" onclick="ga('send', 'event', 'Offcanvas', 'Academics', 'Fields of Study')">Fields of Study</a></li>
