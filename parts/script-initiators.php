<?php if (is_page_template('template-people-directory.php') || is_page_template('template-research-projects.php') ) : ?>
...
<?php endif;?>
<?php if (is_page_template('template-research-projects.php')):?>
	<script>
		jQuery(document).ready( function($) {
